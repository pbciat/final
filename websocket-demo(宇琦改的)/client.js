...
// 一開始隱藏button-cue
var obt = document.querySelector('.button-cue').style.display = 'none';
var responsetime = document.querySelector('#rt').style.display = 'none';
...
document.onkeydown = function(e) {
    ...
    if (detect_key && ((e.keyCode == 69 || e.keyCode == 73) || e.keyCode == 32)) {
        ...
        if (e.keyCode == 69) { // keycode for e   i: 73
            ...
            document.getElementById("TWpic").style.display = 'none';
            document.querySelector('.button-cue').style.display = 'inline';
        }
